...
/*************模拟比较器负端比较电压选择****************/
enum CMPRF {CMPRF0=0,CMPRF1,CMPRF2,CMPRF3,CMPRF4,CMPRF5,CMPRF6,CMPRF7,CMPRF8,CMPRF9,CMPRF10,CMPRF11,CMPRF12,CMPRF13,CMPRF014,CMPRF015};
...
void CMP_Test(void)
{
	CMP_Init(CMP1,CMPRF1);  //选择正端通道1，负端电压选择1/16VDD
	while(1)
	{
