...
//  最后更正日期:
// 	版本		:
// 	更改记录	:746 rom前256byte禁止查表,因此在编译的时候，设置keil->option for Target->BL51 Locate->Code Range:0x100
//*************************************************************
...
//=========================P1、P2、P3、P4 准双向IO设置=========================================//
#define		P00M					(BC(P0CFG0,0),BC(P0CFG0,1))							//设置P00为准双向IO
#define		P01M					(BC(P0CFG0,2),BC(P0CFG0,3))							//设置P01为准双向IO
#define		P02M					(BC(P0CFG0,4),BC(P0CFG0,5))							//设置P02为准双向IO
#define		P03M					(BC(P0CFG0,6),BC(P0CFG0,7))							//设置P03为准双向IO
#define		P04M					(BC(P0CFG1,0),BC(P0CFG1,1))							//设置P04为准双向IO
#define		P05M					(BC(P0CFG1,2),BC(P0CFG1,3))							//设置P05为准双向IO
#define		P06M					(BC(P0CFG1,4),BC(P0CFG1,5))							//设置P06为准双向IO
#define		P07M					(BC(P0CFG1,6),BC(P0CFG1,7))							//设置P07为准双向IO
...
#define		P46M					(BC(P4CFG1,4),BC(P4CFG1,5))							//设置P46为准双向IO
#define		P47M					(BC(P4CFG1,6),BC(P4CFG1,7))							//设置P47为准双向IO

#define		P50M					(BC(P5CFG0,0),BC(P5CFG0,1))							//设置P50为准双向IO
#define		P51M					(BC(P5CFG0,2),BC(P5CFG0,3))							//设置P51为准双向IO

//=========================P1、P2、P3、P4  强推挽IO设置=========================================//
#define		P00PM					(BS(P0CFG0,0),BC(P0CFG0,1))							//设置P00为强推挽IO
#define		P01PM					(BS(P0CFG0,2),BC(P0CFG0,3))							//设置P01为强推挽IO
#define		P02PM					(BS(P0CFG0,4),BC(P0CFG0,5))							//设置P02为强推挽IO
#define		P03PM					(BS(P0CFG0,6),BC(P0CFG0,7))							//设置P03为强推挽IO
#define		P04PM					(BS(P0CFG1,0),BC(P0CFG1,1))							//设置P04为强推挽IO
#define		P05PM					(BS(P0CFG1,2),BC(P0CFG1,3))							//设置P05为强推挽IO
#define		P06PM					(BS(P0CFG1,4),BC(P0CFG1,5))							//设置P06为强推挽IO
#define		P07PM					(BS(P0CFG1,6),BC(P0CFG1,7))							//设置P07为强推挽IO
...
#define		P46PM					(BS(P4CFG1,4),BC(P4CFG1,5))							//设置P46为强推挽IO
#define		P47PM					(BS(P4CFG1,6),BC(P4CFG1,7))							//设置P47为强推挽IO

#define		P50PM					(BS(P5CFG0,0),BC(P5CFG0,1))							//设置P50为强推挽IO
#define		P51PM					(BS(P5CFG0,2),BC(P5CFG0,3))							//设置P51为强推挽IO
//=========================P1、P2、P3、P4  高阻态(仅输入)IO设置=========================================//
#define		P00IM					(BC(P0CFG0,0),BS(P0CFG0,1))							//设置P00为高阻态IO
#define		P01IM					(BC(P0CFG0,2),BS(P0CFG0,3))							//设置P01为高阻态IO
#define		P02IM					(BC(P0CFG0,4),BS(P0CFG0,5))							//设置P02为高阻态IO
#define		P03IM					(BC(P0CFG0,6),BS(P0CFG0,7))							//设置P03为高阻态IO
#define		P04IM					(BC(P0CFG1,0),BS(P0CFG1,1))							//设置P04为高阻态IO
#define		P05IM					(BC(P0CFG1,2),BS(P0CFG1,3))							//设置P05为高阻态IO
#define		P06IM					(BC(P0CFG1,4),BS(P0CFG1,5))							//设置P06为高阻态IO
#define		P07IM					(BC(P0CFG1,6),BS(P0CFG1,7))							//设置P07为高阻态IO
...
#define		P46IM					(BC(P4CFG1,4),BS(P4CFG1,5))							//设置P46为高阻态IO
#define		P47IM					(BC(P4CFG1,6),BS(P4CFG1,7))							//设置P47为高阻态IO

#define		P50IM					(BC(P5CFG0,0),BS(P5CFG0,1))							//设置P50为高阻态IO
#define		P51IM					(BC(P5CFG0,2),BS(P5CFG0,3))							//设置P51为高阻态IO

//=========================P1、P2、P3、P4  开漏输出IO设置=========================================//
#define		P00OM					(BS(P0CFG0,0),BS(P0CFG0,1))							//设置P00为开漏输出IO
#define		P01OM					(BS(P0CFG0,2),BS(P0CFG0,3))							//设置P01为开漏输出IO
#define		P02OM					(BS(P0CFG0,4),BS(P0CFG0,5))							//设置P02为开漏输出IO
#define		P03OM					(BS(P0CFG0,6),BS(P0CFG0,7))							//设置P03为开漏输出IO
#define		P04OM					(BS(P0CFG1,0),BS(P0CFG1,1))							//设置P04为开漏输出IO
#define		P05OM					(BS(P0CFG1,2),BS(P0CFG1,3))							//设置P05为开漏输出IO
#define		P06OM					(BS(P0CFG1,4),BS(P0CFG1,5))							//设置P06为开漏输出IO
#define		P07OM					(BS(P0CFG1,6),BS(P0CFG1,7))							//设置P07为开漏输出IO
...
#define		P46OM					(BS(P4CFG1,4),BS(P4CFG1,5))							//设置P46为开漏输出IO
#define		P47OM					(BS(P4CFG1,6),BS(P4CFG1,7))							//设置P47为开漏输出IO

#define		P50OM					(BS(P5CFG0,0),BS(P5CFG0,1))							//设置P50为开漏输出IO
#define		P51OM					(BS(P5CFG0,2),BS(P5CFG0,3))							//设置P51为开漏输出IO

//=========================P1、P2、P3、P4  准双向IO设置输入=========================================//
#define		P00MI					(BC(P0CFG0,0),BC(P0CFG0,1),SET(P00,1))				//设置P00为准双向IO输入
#define		P01MI					(BC(P0CFG0,2),BC(P0CFG0,3),SET(P01,1))				//设置P01为准双向IO输入
#define		P02MI					(BC(P0CFG0,4),BC(P0CFG0,5),SET(P02,1))			 	//设置P02为准双向IO输入
#define		P03MI					(BC(P0CFG0,6),BC(P0CFG0,7),SET(P03,1))				//设置P03为准双向IO输入
#define		P04MI					(BC(P0CFG1,0),BC(P0CFG1,1),SET(P04,1))				//设置P04为准双向IO输入
#define		P05MI					(BC(P0CFG1,2),BC(P0CFG1,3),SET(P05,1))				//设置P05为准双向IO输入
#define		P06MI					(BC(P0CFG1,4),BC(P0CFG1,5),SET(P06,1))				//设置P06为准双向IO输入
#define		P07MI					(BC(P0CFG1,6),BC(P0CFG1,7),SET(P07,1))				//设置P07为准双向IO输入
...
#define		P42MI					(BC(P4CFG0,4),BC(P4CFG0,5),SET(P42,1))			 	//设置P42为准双向IO输入
#define		P43MI					(BC(P4CFG0,6),BC(P4CFG0,7),SET(P43,1))				//设置P43为准双向IO输入
#define		P44MI					(BC(P4CFG1,0),BC(P4CFG1,1),SET(P44,1))				//设置P44为准双向IO输入
#define		P45MI					(BC(P4CFG1,2),BC(P4CFG1,3),SET(P45,1))				//设置P45为准双向IO输入
#define		P46MI					(BC(P4CFG1,4),BC(P4CFG1,5),SET(P46,1))				//设置P46为准双向IO输入
#define		P47MI					(BC(P4CFG1,6),BC(P4CFG1,7),SET(P47,1))				//设置P47为准双向IO输入

#define		P50MI					(BC(P5CFG0,0),BC(P5CFG0,1),SET(P50,1))				//设置P50为准双向IO输入
#define		P51MI					(BC(P5CFG0,2),BC(P5CFG0,3),SET(P51,1))				//设置P51为准双向IO输入
