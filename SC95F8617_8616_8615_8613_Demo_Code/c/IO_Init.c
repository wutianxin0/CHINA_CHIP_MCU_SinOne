...
void IO_Init(void)
{
	#if (IC_MODEL == SC95F8617)  //SC92F8617引脚定义
	...
	#if (IC_MODEL == SC95F8616)  //SC92F8616引脚定义
	P0CON = 0xFF;  //设置P0为强推挽模式
	P0PH  = 0x00;
	P1CON = 0x00;  //设置P1为高阻输入模式
	P1PH  = 0x00;
	...
	#if (IC_MODEL == SC95F8615)  //SC92F8615引脚定义
	P0CON = 0xFF;  //设置P0为强推挽模式
	P0PH  = 0x00;
	P1CON = 0x00;  //设置P1为高阻输入模式
	P1PH  = 0x00;
	...
	P5CON = 0xFF;  //设置P5为强推挽模式
	P5PH  = 0x00;
	SC95F8615_NIO_Init(); //未引出IO口配置
	#endif
	
	#if (IC_MODEL == SC95F8613)  //SC92F8613引脚定义
	P0CON = 0xFF;  //设置P0为强推挽模式
	P0PH  = 0x00;
	P1CON = 0x00;  //设置P1为高阻输入模式
	P1PH  = 0x00;
