...
void PWMinit(void)
{
 	PWMCFG = 0x03;			// - - 00 - 011  PWM输出不反向,16M选择PWM时钟源为Fosc/8 = 2MHZ;1/2us
 	PWMPRD = 99;			//	PWM周期=(99+1)*(1/2us)=50us	;
 	PWMDTY0 = 50;			//PWM0的Duty = 50/100 =1/2
	PWMDTY1 = 25;			//PWM0的Duty = 25/100 =1/4
	PWMDTY2 = 10;			//PWM0的Duty = 10/100 =1/10
 	PWMCR = 0xAA;			// 10-- 0001   开PWM,允许PWM输出到P27/P26/P25；
}
//*************************************************************
