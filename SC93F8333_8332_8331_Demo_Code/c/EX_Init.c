...
void EX_Init(void)
{	
	//配置中断口INT03、INT11、INT24/25
	P1CON &= 0Xd7;     //中断IO口设置为高阻输入
	P1PH  |= 0x28;     //中断IO口设置为高阻带上拉
	P2CON &= 0XFC;     //中断IO口设置为高阻输入
	P2PH  |= 0x03;     //中断IO口设置为高阻带上拉
 
	//配置INT03上升沿中断、INT11双沿中断、INT24/25下降沿中断
    //下降沿设置	
	INT0F = 0X00 ;    //xxxx 0000  0关闭 1使能
	INT1F = 0X02 ;    //xxxx xxxx  0关闭 1使能
    INT2F = 0X30 ;    //0000 xxxx  0关闭 1使能
    //上升沿设置	
	INT0R = 0X08 ;    //xxxx 0000  0关闭 1使能 
	INT1R = 0X02 ;    //xxxx xxxx  0关闭 1使能
