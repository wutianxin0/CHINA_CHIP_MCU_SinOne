...
//	文件名称	: IAP.c
//	作者		: 
//	模块功能	:IAP( 128byte EEPROM)的使用
//	局部函数列表:
//  最后更正日期:
// 	版本		:
// 	更改记录	:711 rom前256byte禁止查表,因此在编译的时候，设置keil->option for Target->BL51 Locate->Code Range:0x100
//*************************************************************

#include "h\SC91F711_C.h"
#include <intrins.h>
//============================
//模块局部变量定义
//============================
...
unsigned char Addr;
unsigned char code  *POINTER = 0x0780;								//定义ROM指针地址：0x0780
