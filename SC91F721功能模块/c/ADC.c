...
// 调用全局变量：无
// 修改全局变量：无
// 备注		：选择参考电压;选择ADC输入口;开ADC电源;设置ADC转换时钟(主频转换约7us);选通ADC通道;开始转换;完成转换,清EOC标志.
//**************************************************************	
void ADC_init()
{
	ADCCFG=0x00;						//选择ADD为参考电压，设置ADCCFG=0x00.
	P3ADC=0x10;							//P34作ADC输入口
	ADCCR=0xE4;							//11100100, 打开ADC电源,ADC CLK=Fosc/6,选通P34通道
}
//*************************************************************
